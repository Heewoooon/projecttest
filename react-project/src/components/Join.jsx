      ...
      <form>
        <div className='formbox'>
          <div className="mb-3 loginbox2">
            ...
            <input type="text" className="form-control" id="formGroupExampleInput" placeholder="아이디를 입력해주세요"/>
          </div>
          <div className="mb-3 loginbox2">
            <label htmlFor="formGroupExampleInput2" className="form-label doglabel">비밀번호</label>
            <input type="password" className="form-control" id="formGroupExampleInput2" placeholder="비밀번호를 입력해주세요"/>
          </div>
          <div className="mb-3 loginbox2">
            <label htmlFor="formGroupExampleInput" className="form-label doglabel">비밀번호확인</label>
            <input type="password" className="form-control" id="formGroupExampleInput" placeholder="비밀번호를 확인해주세요"/>
          </div>
          <div className="mb-3 loginbox2">
            <label htmlFor="formGroupExampleInput" className="form-label doglabel">이름</label>
            <input type="text" className="form-control" id="formGroupExampleInput" placeholder="이름을 입력해주세요"/>
          </div>
          <div className="mb-3 loginbox2">
            <label htmlFor="formGroupExampleInput2" className="form-label doglabel">닉네임</label>
            <input type="text" className="form-control" id="formGroupExampleInput2" placeholder="사용하실 닉네임을 입력해주세요"/>
          </div>
          <div className="mb-3 loginbox2">
            <label htmlFor="formGroupExampleInput" className="form-label doglabel">전화번호</label>
            <input type="text" className="form-control" id="formGroupExampleInput" placeholder="전화번호를 입력해주세요"/>
          </div>
          <div className='mb-3 loginbox2'>
          <button type="button" className="btn btn-primary btn2">회원가입</button>
        </div>
        </div>
      </form>
